...
<head>
    ...
    <!-- Diseñp de tabla-->
    <link href="../css/diseño-table.css" rel="stylesheet">
...
?>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../inicio/index.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="..//inicio/foro.php">Foro</a>
                    </div>
                </div>
            </li>
...
<?php
    ...
    $query = "SELECT u.id, u.nombre, u.apellido, c.fecha_conexion
            FROM usuarios u
            JOIN conexiones c ON u.id = c.usuario_id
            ORDER BY u.nombre, u.apellido, c.fecha_conexion";
    ...
    if ($resultado->num_rows > 0) {
        ...
        echo "<table>";
        echo "<tr><th>Nombre</th><th>Apellido</th><th>Fecha y Hora de Conexión</th><th>Eliminar</th></tr>";

        // Itera a través de las filas del resultado y muestra los datos en la tabla
        while ($fila = $resultado->fetch_assoc()) {
            echo "<tr><td>" . $fila["nombre"] . "</td><td>" . $fila["apellido"] . "</td><td>" . $fila["fecha_conexion"] . "</td>";
            echo "<td><button class='eliminar-usuario' data-id='" . $fila["id"] . "'>Eliminar</button></td>";
        echo "</tr>";
    }
        echo "</table>";
    } else {
        // Muestra un mensaje si no hay conexiones registradas
